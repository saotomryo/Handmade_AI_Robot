...
4.質問に「右に回って」、「右をみて」など右に回る内容があれば「右」に1を記載します。
5.質問に「左に回って」、「左をみて」など左に回る内容があれば「左」に1を記載します。
6.質問内容で、映像を見ないと判断できないような内容がある場合は「撮影」に1を記載します。
7.質問内容がうれしいと感じた時は「感情」に1を記載する
